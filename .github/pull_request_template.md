# [Nome do Projeto] - [Título Breve da Alteração]

## Descrição
Uma descrição detalhada do que este pull request muda. Inclua informações sobre o que cada commit faz e o motivo de cada mudança.
...
## Impactos no Deploy
Descreva qualquer impacto que essa mudança possa causar em processos de deploy, banco de dados, etc.

## Dependências
Liste quaisquer dependências que precisam ser instaladas ou atualizadas para esta mudança.

## Issues
Informe aqui o link da issue que você está resolvendo.

## Observações Adicionais
Qualquer outra informação que você acha que será útil para os revisores entenderem e avaliarem seu pull request.